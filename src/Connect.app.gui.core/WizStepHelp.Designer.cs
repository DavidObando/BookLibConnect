...
namespace BookLibConnect.App.Gui {
  partial class WizStepHelp {
    ...
    private void InitializeComponent () {
      ...
      this.label1.Text = "A User Guide is provided as a PDF document.";
      // 
      // tableLayoutPanel1
      // 
      ...
      this.label2.Text = "The User Guide can also be opened with the [F1] key or via the app main window\'s " +
    "system menu.  ";
      // 
      // button1
      // 
      ...
      this.button1.Text = "Open User Guide …";
